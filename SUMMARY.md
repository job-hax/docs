...
* [Vision](book/1.vision.md)
* [Backend REST API](book/2.backend_api.md)
* [Database Structure](book/3.database_structure.md)
...
* [UML Component Diagram](book/9.uml_activity.md)
* [UML Class Diagram](book/10.uml_class.md)
